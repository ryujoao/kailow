        ...
        <div className={style.bodyPdp}>
            ...
            <div className={style.containerPdp}>
                ...
                <div className={style.divTitlePdp}>
                    <h1 className={style.titlePdp}>Polítia de Privacidade</h1>
                </div>
                ...
                <div className={style.cardPdp}>
                    <div className={style.tudoPdp}> 
                        <p className={style.textoPdp}>
                            ...
                            É política do Kailow respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Kailow, e outros sites que possuímos e operamos.
